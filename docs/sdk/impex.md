...
Results are scoped to jobs initiated by your user unless you have elevated access
(e.g., `supervisor:pf`). See the sample response below for the export job status.
